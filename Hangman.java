                        ...
                        if(spelare.lista.isEmpty()){
                            ...
                            while(failedGuessCounter < 3){
                                for (int i = 0; i < spelare.lista.size(); i++) {
                                    ...
                                    ordAlgoritm.printUpdatedHiddenSlumpord(guess,slumpOrd);

                                     if(slumpOrd.contains(guess)){
                                        System.out.println("Bra jobbat " + spelare.lista.get(i) + ", +1 poäng");
                                     //   lista.spelare.ökaPoäng(spelare.lista.get(i));
                                     //   lista.spelare.printPoäng();

                                    }
                                    else {
                                        System.out.println("");
                                        storeFailedguesses += guess;
                                        System.out.println(storeFailedguesses);
                                        failedGuessCounter++;
                                    } 
                                }
